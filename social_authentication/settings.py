...
SECRET_KEY = '_w9=07zihhq#xd04zj=ac&+96ifb5t94^h%rtmki%zt@(n+8di'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['socialauth.org','127.0.0.1']
...
SOCIAL_AUTH_FACEBOOK_KEY = '1133152433873824'  # App ID
SOCIAL_AUTH_FACEBOOK_SECRET = '721aadb58a16316b9530f07ce1701f47'  # App Secret


SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = '634305928250-kmhp8cg1iah3mt1kt6bh92impejggg66.apps.googleusercontent.com'  # App ID
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = 'aImoAE69TRnbHSOF2GG6bZM3'  # App Secret
